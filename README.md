...
## V2.13.2 Revised — Automatic Scores
- Scheduler-only external score synchronization.
- Normal member browsing reads Supabase only.
- Actual kickoff timestamps handle Wednesday/Thursday/Saturday/Monday/special games.
- Final-only scoring remains unchanged.
- Commissioner manual refresh fallback.
- Supabase Cron installer included.
